...
Recolha de Dados: Script automático que consome dados JSON de fontes dump1090 (Reais ou Simuladas).
...
graph LR
    ...
    subgraph "Servidor Debian (Proxmox)"
        B[Coletor Python<br>coletor.py] -- Normalização --> C[(Base de Dados<br>SQLite)]
